...
! @param[inout] lw_heating_rate_rts     LW heating rate
! @param[inout] lw_down_surf_rts        LW downward flux at the surface
! @param[inout] lw_up_tile_rts          LW upward tiled surface flux
