...
!> @brief Provides access to the members of the function_space class.

!> @details Accessor functions for the function_space class are defined in this module.

!> @param get_ncell          Returns the number of cells in the function space
!> @param get_cell_dofmap    Returns the cell dofmap (degree of freedom map) for
!>                             the function space
